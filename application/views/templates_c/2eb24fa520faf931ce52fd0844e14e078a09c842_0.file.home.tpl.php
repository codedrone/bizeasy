<?php
/* Smarty version 3.1.30, created on 2018-06-15 11:35:13
  from "/var/www/api/bizeazy/application/views/templates/web/home.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5b23a471b11a57_19813613',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2eb24fa520faf931ce52fd0844e14e078a09c842' => 
    array (
      0 => '/var/www/api/bizeazy/application/views/templates/web/home.tpl',
      1 => 1529062512,
      2 => 'file',
    ),
  ),
...
function content_5b23a471b11a57_19813613 (Smarty_Internal_Template $_smarty_tpl) {
if (!is_callable('smarty_modifier_truncate')) require_once '/var/www/api/bizeazy/application/third_party/smarty/libs/plugins/modifier.truncate.php';
?>
<!doctype html>
<html>
    <head>
...
assets/theme/web/home/images/logo.png" type="image/x-icon">
                ...
                <div class="banner-img">
                    <div class="banner-container">
                        <div class="banner-content">
                            ...
                            <div>
                                <?php if ($_smarty_tpl->tpl_vars['HTTP_HOST']->value == 'www.bizeazy.net') {?>
                                    ...
                                    <?php } elseif ($_smarty_tpl->tpl_vars['HTTP_HOST']->value == 'bizeazy.coderspreview.com') {?>
                                        <a href="https://apps.shopify.com/bizeazy-the-5-minute-mobile-app-maker" class="theme-btn"> Get started <i class="icon icon-chevron-right"></i></a>
                                    <?php } else { ?>
                                        <a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
Authentication/access" class="theme-btn banner-btn">Get Started<i class="icon icon-chevron-right"></i></a>
                                <?php }?>  
                            </div>
                        </div>
                            ...
                            <section class="slider">
                                    <div class="flexslider">
                                      <ul class="slides">
                                        <li>
                                            <img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
assets/theme/web/home/images/mobile_1.png">
                                            </li>
                                            <li>
                                            <img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
...
assets/theme/web/home/images/mobile_5.png">
                                            ...
                                            <li>
                                            <img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
assets/theme/web/home/images/mobile_4.png">
                                            </li>
                                      </ul>
                                    </div>
                                  </section>
...
assets/theme/web/home/images/free-update.png" alt=""></span>
                    ...
                    <div class="bizeasy-col-3 diff-feature-img">
                        <img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
assets/theme/web/home/images/mobile_6.png" alt="" style="margin-top: 30px;">
                    </div>
                    <div class="bizeasy-col-3">
                        <ul class="feature-row">
                        <li class="feature-blog">
            ...
            <div class="bizeasy-container">
                <div class="full-width-row">
                    ...
                    <div class="bizeasy-col-2 app-mobile-img">
                        <img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
assets/theme/web/home/images/mobile_5.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="full-width-row iphone-app-main" >
            <div class="bizeasy-container">
                <div class="full-width-row">
                    ...
                    <div class="bizeasy-col-2 app-mobile-img">
                        <img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
assets/theme/web/home/images/blog-details.png" alt="">
                    </div>
                </div>
            </div>
        </div>
      ...
      <div class="full-width-row android-app-main faq-main" id="faq">
        <div class="bizeasy-container">
            ...
            <div class="faq-accordion_container">
                <div class="accordion_head current">Will I need an Apple (IOS) and/or Google (Android) Developer account?<span class="plusminus">+</span>

                </div>
                <div class="accordion_body">
                    <p>Yes. In order for us to submit your mobile app to the App Stores, a developer account (Apple or Google or both depending on your subscription) needs to be created. But don’t worry, we will look after dealing with the App Store’s so you don’t have to! All we need is for you to add us to your developer account profile. We will then submit your mobile app on your behalf. If you have questions or concerns, we’re always available via email, phone or chat.</p>
                </div>
            <div class="accordion_head">Can I purchase the app rather than subscribe to a monthly plan?<span class="plusminus">+</span>

            </div>
            <div class="accordion_body" style="display: none;">
            <p>Yes. We understand that some customers are more interested in buying their app outright, rather than renting them for a monthly fee. Our “Purchase Plan”, is the most cost-effective solution you will find anywhere!  Pay a one-time charge to purchase your app, source code and copyright at a fraction of the cost it would take to hire a software developer or development firm. </p>
            </div>
            <div class="accordion_head">Can I have my app customized after it’s live on the App Store?<span class="plusminus">+</span>
            </div>
            <div class="accordion_body" style="display: none;">
            <p>Yes. It’s quite normal for our customers to request customizations. We offer very cost effective flat rates and hourly rate “customization” contracts depending on the requirements.</p>
            </div>

            <div class="accordion_head">If I purchase the Basic Plan, can I upgrade in the future?<span class="plusminus">+</span>
            ...
            <div class="accordion_head">How long before my App is available on the AppStore?<span class="plusminus">+</span>

            </div>
            <div class="accordion_body" style="display: none;">
                <p>1 day for Google Play. Up to 5 days for the AppStore.</p>
            </div>
             <?php
            ...
            <div class="bizeasy-container">
                <div class="bizeasy-col-2">
                    <ul class="biz-address">
                        <li><i class="fa fa-envelope"></i><span> info@bizeasy.com</span></li>
