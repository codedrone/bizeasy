...
<html>
    <head>
        ...
        <script type="text/javascript" src="{$base_url}assets/theme/web/home/js/jquery-1.9.1.js"></script>
        <link href='{$base_url}assets/theme/web/home/css/style.css' rel='stylesheet' type='text/css'>
        <link rel="stylesheet" type="text/css" href="{$base_url}assets/theme/web/home/css/font-family.css">
        <link rel="stylesheet" type="text/css" href="{$base_url}assets/theme/web/home/css/fontawesome.min.css">
        <link rel="stylesheet" type="text/css" href="{$base_url}assets/theme/web/home/css/flexslider.css">
...
<body>
    <header>
        <div class="bizeasy-container">
            <div class="main-logo">
                <a href="{$base_url}">
                    <img src="{$base_url}assets/theme/web/home/images/logo.png" alt="" title="Logo">
                </a>
            </div>
                        ...
                        <div class="banner-slider">
                            <section class="slider">
                                    <div class="flexslider">
                                      <ul class="slides">
                                        <li>
                                            <img src="{$base_url}assets/theme/web/home/images/mobile_1.png">
                                            </li>
                                            <li>
                                            <img src="{$base_url}assets/theme/web/home/images/mobile_6.png">
                                            </li>
                                            <li>
                                            <img src="{$base_url}assets/theme/web/home/images/mobile_5.png">
                                            </li>
                                            <li>
                                            <img src="{$base_url}assets/theme/web/home/images/mobile_4.png">
                                            </li>
                                      </ul>
                                    </div>
                                  </section>
    ...
    <div class="wrapper">
            ...
            <div class="bizeasy-container">
                <div class="full-width-row">
                    <div class="bizeasy-col-3">
                        <h2 class="ourwork_title">6 Steps to Create App for Shopify Store</h2>
                        <p>Take advantage of Bizeazy’s online Shopify mobile app maker to create app for your Shopify store as well eCommerce store. Easy to operate and clutter Shopify mobile app for all the enormous user-experience. We guide you through the steps for how you can create mobile app for Shopify store. </p>
                    </div>
                    <div class="bizeasy-col-3">
                        <ul class="feature-row">
                            <li class="feature-blog">
                                ...
                                <!-- <a href="#"><img src="{$base_url}assets/theme/web/home/images/feature_1.png" alt=""></a> -->
                            ...
                            <li class="feature-blog">
                                ...
                                <div class="feature-detail-row">
                                    <h3>Install the Bizeazy Demo App to Your Mobile</h3>
        ...
        <div class="full-width-row diff-feature-main" id="features">
            <div class="bizeasy-container">
                <div class="full-width-row feature-main-title">
                    <h2 class="mobile-app-title">Be Updated With Bizeazy Blog</h2>
                </div>
                <div class="full-width-row">
                   <div class="bizeasy-col-3">
                        ...
                        <ul class="feature-row">
                        <li class="feature-blog">
                            <span><img src="{$base_url}assets/theme/web/home/images/easy-setup.png" alt=""></span>
                            <div class="feature-detail-row">
                        ...
                        <li class="feature-blog">
                            <span><img src="{$base_url}assets/theme/web/home/images/notification.png" alt=""></span>
                            <div class="feature-detail-row">
                                <h3>Native code</h3>
                        ...
                        <li class="feature-blog">
                            <span><img src="{$base_url}assets/theme/web/home/images/free-update.png" alt=""></span>
                            <div class="feature-detail-row">
                                <h3>Free Updates</h3>
                    ...
                    <div class="bizeasy-col-3 diff-feature-img">
                        <img src="{$base_url}assets/theme/web/home/images/blog-details.png" alt="" style="margin-top: 30px;">
                    </div>
                    <div class="bizeasy-col-3">
                        <ul class="feature-row">
                        <li class="feature-blog">
                            <span><img src="{$base_url}assets/theme/web/home/images/native-code.png" alt=""></span>
                            <div class="feature-detail-row">
                        ...
                        <li class="feature-blog">
                            <span><img src="{$base_url}assets/theme/web/home/images/hassel-free.png" alt=""></span>
                            <div class="feature-detail-row">
                        ...
                        <li class="feature-blog">
                            <span><img src="{$base_url}assets/theme/web/home/images/easy-custom.png" alt=""></span>
                            <div class="feature-detail-row">
            ...
            <div class="bizeasy-container">
                <div class="full-width-row">
                    <div class="bizeasy-col-2">
                        <h2 class="mobile-app-title">Create an iPhone App for Shopify Store</h2>
                    ...
                    <div class="bizeasy-col-2 app-mobile-img">
                        <img src="{$base_url}assets/theme/web/home/images/mobile_1.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="full-width-row">
                    <div class="bizeasy-col-2">
                        ...
                        <div class="align-center">
                            <img src="{$base_url}assets/theme/web/home/images/android-mobile.png" alt="">
                        </div>
        ...
        <div class="full-width-row iphone-app-main" >
            <div class="bizeasy-container">
                <div class="full-width-row">
                    <div class="bizeasy-col-2">
                        <h2 class="mobile-app-title">Why Bizeazy for Creating App for Shopify Store</h2>
                    ...
                    <div class="bizeasy-col-2 app-mobile-img">
                        <img src="{$base_url}assets/theme/web/home/images/mobile_5.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="full-width-row">
                    ...
                    <div class="price-columns">
                        <ul class="price standard">
                            ...
                            <li class="orange"><span class="price-tag">$ 9.99 <br/><small>Per Month</small></span></li>
                    ...
                    <div class="price-columns">
                        <ul class="price business">
                            ...
                            <li class="sky"><span class="price-tag">$ 21.99 <br/><small>Per Month</small></span></li>
      ...
      <div class="full-width-row android-app-main faq-main" id="faq">
        <div class="bizeasy-container">
            ...
            <div class="faq-accordion_container">
             ...
             {foreach $faqs as $value}
                <div class="accordion_head">{$value.tQuestion}<span class="plusminus">+</span>
        ...
        <div class="full-width-row android-app-main blog-main" id="blog">
            <div class="bizeasy-container">
                <div class="full-width-row">
                    <div class="mobile-app-title">Be Updated With Bizeazy Blog</div>
                    <p> &nbsp;</p>    
                </div>
                <div class="full-width-row">
                    {section name=i loop=$blog_data}
                    <div class="bizeasy-col-3">
                        <img class="blog-img" src="{$blog_data[i].image}" alt="">
                        <div class="biz-blog-cont">
                            <h2>{$blog_data[i].date}</h2>
                            <h3>{$blog_data[i].title|truncate:65:'...'}</h3>
                            <p>{$blog_data[i].content}</p>
                            <div class="full-width-row"><a class="theme-btn" href="{$blog_data[i].url}">Read More</a></div>
                        </div>
                    </div>
                    {/section}     
                    ...
                    <div class="footer-form">
                        <form>
                            ...
                            <div class="full-width-row recaptcha">
                                <img src="{$base_url}assets/theme/web/home/images/recaptcha.png" alt="">
                            </div-->
                            <div class="full-width-row">
            ...
            <div class="bizeasy-container">
                <div class="bizeasy-col-2">
                    <ul class="biz-address">
                        <li><i class="fa fa-envelope"></i><span> info@bizeazy.com</span></li>
                        <li><i class="fa fa-building"></i><span> Sherwood Park,    <br/>Alberta, T6H 5k5 <br/>Canada</span></li>
                        <li><i class="fa fa-phone"></i><span> +1-780-932-6381</span></li>
                    </ul>
                    <ul class="social-row">
                 ...
                 <div class="full-width-row">
                    <div class="footer-copyright">© 2018 Bizeazy all right reserved</div>
                </div>    
            </div>
        </footer>
          ...
          function contactform()
            {
                ...
                email_id_status=homeEmailvalidation();
...
<script src="{$base_url}assets/theme/admin/js/commonValidation.js"></script>

<script src="{$base_url}assets/theme/web/home/js/accordion.js" type="text/javascript"></script>
<script type="text/javascript">
...
<!-- FlexSlider -->
  <script src="{$base_url}assets/theme/web/home/js/jquery.flexslider.js" type="text/javascript"></script>
