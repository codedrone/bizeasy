                            ...
                            <div class="ks-grid">
                                ...
                                <div class="content-block">
                                    <div class="row">
                                                ...
                                                <li>
                                                    <div class="item-content">
                                                        ...
                                                        <div class="item-media">
                                                            <img src="{$value->image->src}" alt="" style="height: 44px !important;width: 53px !important;" /></div>
                                        ...
                                        <div class="col-100 tablet-50 home-grid-100 home-bg-gray">
                                            <div class="row checkout-shipping-row">
                                                <div class="col-50 shipping-txt">SHIPPING AND HANDLING</div>
                                                <div class="col-50 free-shipping-txt">free shipping</div>
                                            </div>
                                ...
                                <div class="content-block">
                                    <div class="row">
                                        <div class="col-80 qty-item-row"><a href="{$base_url}ShopifyApp/iosAndroidPublishApps/android/androidWishlist" class="vButtonColor vButtonFontColor button button-big">Check out</a></div>
                                    </div>
                                    <div class="row">
