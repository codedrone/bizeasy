                            ...
                            <div>
                                {if $HTTP_HOST eq 'www.bizeazy.net'}
                                    ...
                                    {else if $HTTP_HOST eq 'bizeazy.coderspreview.com'}
                                        <a href="https://apps.shopify.com/bizeazy-the-5-minute-mobile-app-maker" class="theme-btn"> Get started <i class="icon icon-chevron-right"></i></a>
                                    {else}
                                        <a href="{$base_url}Authentication/access" class="theme-btn banner-btn">Get Started<i class="icon icon-chevron-right"></i></a>
                                {/if}  
                            </div>
                        </div>
                                    ...
                                    <div class="flexslider">
                                      <ul class="slides">
                                        <li>
                                            ...
                                            <li>
                                            <img src="{$base_url}assets/theme/web/home/images/blog-details.png">
                                            </li>
                                      </ul>
                                    </div>
                                  </section>
        ...
        <div class="full-width-row iphone-app-main" >
            <div class="bizeasy-container">
                <div class="full-width-row">
                    ...
                    <div class="bizeasy-col-2 app-mobile-img">
                        <img src="{$base_url}assets/theme/web/home/images/feature-step.png" alt="">
                    </div>
                </div>
            </div>
        </div>
